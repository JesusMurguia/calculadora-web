...
class PacienteBasicoModel {
  ...
  create = async (data) => {
    ...
    try {
      const sql = `INSERT INTO ${this.table} (idpaciente, puntos, dependencia) VALUES (?, ?, ?)`;
      await query(sql, [
        this.paciente.idpaciente,
        this.paciente.puntos,
        this.paciente.dependencia,
      ]);
