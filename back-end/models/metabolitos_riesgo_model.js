...
class MetabolitosModel {
	...
	update = async (id, data) => {
		try {
			const sql = `UPDATE ${this.table} SET 3HC_O_Gluc = ?, 3HC = ?, Nicotine_N_Gluc = ?, 4HPBA = ?, Cotinine_oxide = ?, Nicotine_N_oxide = ?, riesgo = ? WHERE idpaciente = ?`;
